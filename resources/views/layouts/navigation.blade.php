@php use App\Models\Category;use App\Models\Item;use App\Models\Setting; @endphp
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                ...
                <div class="font-medium text-sm text-gray-500">{{ Auth::user()->login }}</div>
            </div>
